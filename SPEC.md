...
整合确认（2026-09-12）：保留手势模块 v0.2 的 STRETCH，每次有效展开增加 25%，面饼未达到 100% 时服务器拒绝入炉。当前演示每轮 5 分钟、烤制 20 秒，烤好后 15 秒内需取出；番茄、香肠和芝士在菜板需要 5 次有效切割。时间和阈值集中在正式 shared/server 代码中。
